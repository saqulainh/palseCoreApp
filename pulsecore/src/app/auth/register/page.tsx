...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If registration is successful, the store also auto-logins.
      // Next, we should redirect to onboarding.
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-[#0A0A0F] flex flex-col items-center justify-center px-5 py-10 relative overflow-x-hidden overflow-y-auto">
        ...
        <div className="w-full max-w-sm my-auto">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold font-lexend text-[#F9FAFB]">Join PulseCore</h1>
            <p className="text-[#9CA3AF] mt-2">Start your intelligent fitness journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm text-[#9CA3AF] font-medium ml-1">Username</label>
              <input
                type="text"
                value={username}
          ...
          <p className="mt-8 text-center text-[#9CA3AF] text-sm">
            ...
            <Link href="/auth/login" className="text-[#b8c4ff] hover:underline font-medium">
              Sign In
            </Link>
          </p>
        </div>
